...
//quiero que el sistema busque todos los productos con cantidad igual a cero y que si es igual a cero agregue una nueva propiedad llamada "existencia" y que al frente de esa propiedad diga. Existencias igual a 



//console.log(productos.findIndex(producto=> producto.categoria=="Desayuno"))

productos.map((producto,posicion)=>{
producto.categoria=="Desayuno"
if (producto.categoria=="Desayuno"){
