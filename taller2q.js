...
//quiero que el sistema me muestre unicamente los productos cuya fecha de vencimiento sea del año 2025

productos.map(producto=>{
    if(new Date(producto.fechaVencimiento).getFullYear()==2025){
