...
//encontrar el producto mas caro de la categoria de panaderia

const filtrarcategoria= productos.filter(producto=>producto.categoria=="Panadería").sort((a,b)=>b.precio-a.precio)
