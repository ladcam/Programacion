...
//quiero sumar los impuestos de los productos con cualquier rango de precio. Es decir que la persona pueda variar el rango de precio es decir sumar para precios mayores a 3 mayores a 5 o a lo que sea

function sumarimpuesto(precioproducto){
const suma = productos.filter(producto=>producto.precio>=precioproducto).reduce((sumarimpuesto,producto)=>
