...
// necesito un resumen que me muestre categoria: "nombre del producto". es decir que me muestra solo la categoria y el nombre del producto

productos.forEach(producto=>console.log(producto.categoria,":",producto.nombre.producto))
